...
<body>
    ...
    <main>
        ...
        <div id="myCoursesGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-6">
            ...
            myGrid.innerHTML = filtered.map(course => `
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-5">
                        ...
                        <span class="text-xs font-bold uppercase px-2 py-1 rounded-full bg-blue-100 text-blue-700">
